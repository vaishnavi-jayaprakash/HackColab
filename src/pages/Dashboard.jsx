...
import { teamMembers } from "../mock/dashboard.js";
...
export default function Dashboard() {
  ...
  const { stats, hackathons, recentActivity } = data;
      ...
      navbarContent={
        <div>
          ...
          <p className="page-subtitle">
            {stats.activeHackathons} active hackathons · {stats.tasksDueSoon} tasks due this week · 2 merge conflicts need attention
          </p>
        </div>
      }
    >
      <div className="page">
        ...
        <div className="dashboard-columns">
          ...
          <Card className="dashboard-activity">
            <CardHeader title="Recent Activity" action={<button className="link-btn" onClick={() => navigate("/dashboard")}>View all</button>} />
